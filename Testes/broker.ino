...
//Alterar para mandar a corrente e o consumo, se é que da para mandar os dois
//Inicialmente nenhuma ação será executada, mas o ideal é desligar ou ligar o relé, ou seja, a tomada
//A ideia será apenas mensurar o gasto e entendê-lo
void enviaValores() {
